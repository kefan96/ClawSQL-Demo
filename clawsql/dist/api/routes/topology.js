...
export async function topologyRoutes(fastify) {
        ...
        try {
            ...
            return {
                ...
                replicas: topology.replicas.map(r => ({
                    ...
                    serverId: r.serverId,
                    version: r.version,
                    replicationLag: r.replication?.secondsBehindMaster ?? null,
                })),
    ...
    fastify.get('/primary', async (request, reply) => {
        try {
    ...
    fastify.get('/replicas', async (request, reply) => {
        try {
