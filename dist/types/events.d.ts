...
export type EventType = 'topology_change' | 'primary_change' | 'failover_start' | 'failover_complete' | 'failover_abort' | 'switchover_start' | 'switchover_complete' | 'switchover_abort' | 'replication_lag' | 'instance_down' | 'instance_up' | 'problem_detected' | 'problem_resolved' | 'schema_change';
